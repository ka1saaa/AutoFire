...
- 联系人昵称/备注的本地录入、搜索、排序、勾选、全选与取消全选；
...
1. 点击“保存并用 Edge 打开”，在官方网页自行登录并点击“消息”。
2. 回到 AutoFire，点击“我已登录，管理联系人”；将你可私信的好友昵称逐条录入，或从剪贴板按每行 `昵称` / `昵称|备注` 的格式导入。
3. 勾选联系人并生成表情预览，复制清单后，在网页会话中自行选择和发送表情；结束后点击“记录本次已手动处理”。
